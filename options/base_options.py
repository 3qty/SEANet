...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default=parser.get_default('store_root')+'checkpoints/', help='models are saved here')
        parser.add_argument('--dataroot', default='../rain_dataset', help='path to images folder(should have subfolders for each dataset)')
        parser.add_argument('--setname', default='200h', help='dataset subfolder(should have subfolders train, val, test)')
        ...
        parser.add_argument('--name', type=str, default='CoupleOutUnet', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--dataset_mode', type=str, default='aligned', help='chooses how datasets are loaded. [unaligned | aligned | single]')
        parser.add_argument('--model', type=str, default='seaunet',help='chooses which model file name to use. cycle_gan, pix2pix, test')
